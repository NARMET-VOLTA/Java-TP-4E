...
// Настроить скорость лошадей рандомно ---------
// добавить конпку стоп
// настроить вывод победителя          ----------
...
//----------------HORSES--------------
        ...
        panel_2.add(label_2);
        panel_3.add(label_3);
        panel_4_text.add(firstHorseText);
        ...
        while (true){
            if (!thread_0.isAlive()){
                firstHorseText.changeText("First horse: " + thread_0.horseName());
                break;
            }
            if (!thread_1.isAlive()){
                firstHorseText.changeText("First horse: " + thread_1.horseName());
                break;
            }
            if (!thread_2.isAlive()){
                firstHorseText.changeText("First horse: " + thread_2.horseName());
                break;
            }
            if (!thread_3.isAlive()){
                firstHorseText.changeText("First horse: " + thread_3.horseName());
                break;
            }
